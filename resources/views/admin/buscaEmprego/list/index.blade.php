                                ...
                                <div class="card-body">
                                    <div class="media mb-2">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div
                                                style='background-image:url("/storage/{{ $item->imagemEmprego }}");background-position:center;background-size:cover;height:200px;width:8cm'>
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center mt-4">
                                        <a href="{{ route('admin.buscar.detalhes', $item->id) }}"
                                            class="btn btn-primary light btn-rounded mr-auto">{{ $item->tempoEmprego }}</a>
                                        <a href="{{ route('admin.buscar.detalhes', $item->id) }}"> <span
                                                class="text-black font-w500">saber mais</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
